-- TWNZ_TIMETABLE Database Schema
-- Phase 1 + Full Schema

CREATE DATABASE IF NOT EXISTS TWNZ_TIMETABLE CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE TWNZ_TIMETABLE;
...
-- admin    → Admin@1234
-- teacher1 → Teacher@1234
-- teacher2 → Teacher@1234

INSERT INTO users (username, password_hash, display_name, phone, email, role, is_vip) VALUES
('admin',    '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'ผู้ดูแลระบบ', '0812345678', 'admin@twnz.ac.th', 'admin', 0),
('teacher1', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'ครูสมชาย ใจดี', '0823456789', 'teacher1@twnz.ac.th', 'teacher', 0),
('teacher2', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'ครูสมหญิง รักเรียน', '0834567890', 'teacher2@twnz.ac.th', 'teacher', 0);

-- NOTE: The password hashes above are placeholder; run the seed script to generate correct hashes
-- Use: node backend/src/scripts/seed.js

INSERT INTO announcements (title, content, created_by, is_active) VALUES
('ยินดีต้อนรับสู่ระบบจัดตารางเรียน TWNZ', 'ระบบพร้อมใช้งานแล้ว กรุณาเข้าสู่ระบบเพื่อเริ่มต้นใช้งาน', 1, 1),
('VIP สิทธิพิเศษ', 'สมาชิก VIP จัดตารางได้ไม่จำกัด และ Export Excel/PDF ได้', 1, 1);
